...
riak_fullperf(_Config) ->
    ...
    R2A = riak_load_tester(Bucket, 2000000, 2048, [], lz4),
    output_result(R2A),
    R2B = riak_load_tester(Bucket, 2000000, 2048, [], lz4),
    output_result(R2B),
    R2C = riak_load_tester(Bucket, 2000000, 2048, [], lz4),
    output_result(R2C),
    R5A = riak_load_tester(Bucket, 5000000, 2048, [], lz4),
    output_result(R5A),
    R5B = riak_load_tester(Bucket, 5000000, 2048, [], lz4),
    output_result(R5B),
    R10 = riak_load_tester(Bucket, 10000000, 2048, [], lz4),
    output_result(R10)
    .
