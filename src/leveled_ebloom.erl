...
add_hashlist([], _S, S0, S1, S2, S3) ->
    IntSize = ?INTEGER_SIZE,
    <<S0:IntSize/integer, S1:IntSize/integer, S2:IntSize/integer, S3:IntSize/integer>>;
...
add_hashlist(
    ...
    IntSize = ?INTEGER_SIZE,
    <<S0:IntSize/integer, S1:IntSize/integer, S2:IntSize/integer, S3:IntSize/integer,
        S4:IntSize/integer, S5:IntSize/integer, S6:IntSize/integer, S7:IntSize/integer,
        S8:IntSize/integer, S9:IntSize/integer, S10:IntSize/integer, S11:IntSize/integer,
        S12:IntSize/integer, S13:IntSize/integer, S14:IntSize/integer, S15:IntSize/integer>>;
add_hashlist(
    [{_SegHash, TopHash} | T],
    SlotSplit,
    S0,
...
add_hashlist(
    ...
    <<S0:IntSize/integer, S1:IntSize/integer, S2:IntSize/integer, S3:IntSize/integer,
        ...
        S8:IntSize/integer, S9:IntSize/integer, S10:IntSize/integer, S11:IntSize/integer,
        S12:IntSize/integer, S13:IntSize/integer, S14:IntSize/integer, S15:IntSize/integer,
        S16:IntSize/integer, S17:IntSize/integer, S18:IntSize/integer, S19:IntSize/integer,
        S20:IntSize/integer, S21:IntSize/integer, S22:IntSize/integer, S23:IntSize/integer,
        S24:IntSize/integer, S25:IntSize/integer, S26:IntSize/integer, S27:IntSize/integer,
        S28:IntSize/integer, S29:IntSize/integer, S30:IntSize/integer, S31:IntSize/integer>>;
add_hashlist(
    [{_SegHash, TopHash} | T],
    SlotSplit,
    S0,
...
test_bloom(N, Runs) ->
    ...
    SpliListFun = fun(HashList) ->
        HitOrMissFun = fun(Entry, {HitL, MissL}) ->
    ...
    ListOfBlooms =
        lists:map(
            fun({HL, _ML}) -> create_bloom(HL) end,
