...
handle_cast({manifest_change, Manifest}, State) ->
    ...
    if
        NewManSQN > OldManSQN ->
            ok =
                leveled_pclerk:clerk_promptdeletions(
                    State#state.clerk, NewManSQN
                ),
            % This is accepted as the new manifest, files may be deleted
            UpdManifest0 =
                leveled_pmanifest:merge_snapshot(
    ...
    case
        {
            ...
            leveled_pmanifest:levelzero_present(State#state.manifest)
        }
    of
        {true, _L0Present} ->
...
generate_randomkeys(Count, SQN, Acc) ->
    ...
    RandKey =
        {K, {SQN, {active, infinity}, leveled_codec:segment_hash(K), null}},
...
simple_server_test() ->
    ...
    Key1A_Pre = {
        {o, "Bucket0001", "Key0001", null}, {4005, {active, infinity}, null}
    },
