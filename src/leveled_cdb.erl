...
-spec scan_over_file(file:io_device(), integer(), filter_fun(), term(), any()) ->
    {file_location(), term()}.
...
-spec saferead_keyvalue(
    file:io_device()
) -> false | {any(), binary(), integer(), integer()}.
%% @doc
...
maybelog_get_timing(
    ...
    is_pid(Pid), is_integer(IndexTime), is_integer(ReadTime)
->
    leveled_monitor:add_stat(
